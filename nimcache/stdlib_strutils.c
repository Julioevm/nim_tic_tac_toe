...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/coop/Projects/nim/tic_tac_toe/nimcache/stdlib_strutils.o /home/coop/Projects/nim/tic_tac_toe/nimcache/stdlib_strutils.c */
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, nsuIsDigitStr)(NimStringDesc* s) {
	...
	nimfr_("isDigit", "strutils.nim");
{	result = (NIM_BOOL)0;
	nimln_(148, "strutils.nim");
	{
		if (!((s ? s->Sup.len : 0) == ((NI) 0))) goto LA3_;
		nimln_(149, "strutils.nim");
		result = NIM_FALSE;
		goto BeforeRet_;
	}
	LA3_: ;
	nimln_(151, "strutils.nim");
	result = NIM_TRUE;
	{
		NIM_CHAR c;
		NI i;
		...
		L = (s ? s->Sup.len : 0);
		{
			...
			while (1) {
				...
				if ((NU)(i) > (NU)(s->Sup.len)) raiseIndexError();
				c = s->data[i];
				nimln_(153, "strutils.nim");
				{
					NIM_BOOL T10_;
					T10_ = (NIM_BOOL)0;
					T10_ = nsuIsDigitChar(c);
					if (!!(T10_)) goto LA11_;
					nimln_(154, "strutils.nim");
					result = NIM_FALSE;
					goto BeforeRet_;
				}
				LA11_: ;
				nimln_(3827, "system.nim");
				TM_JGc9b9bh2D3nTdUR7TGyq8aA_22 = addInt(i, ((NI) 1));
				i = (NI)(TM_JGc9b9bh2D3nTdUR7TGyq8aA_22);
